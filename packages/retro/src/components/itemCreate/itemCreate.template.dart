...
import 'itemCreate.dart' as import6;
import 'dart:html';
...
class ViewItemCreateComponent0 extends DebugAppView<import6.ItemCreateComponent> {
  ...
  ViewItemCreateComponent0(AppView<dynamic> parentView,num parentIndex): super(import10.ViewType.COMPONENT,{},parentView,parentIndex,ChangeDetectionStrategy.CheckAlways,nodeDebugInfos_ItemCreateComponent0) {
    rootEl = document.createElement('item-create');
    renderType ??= import12.appViewUtils.createRenderType('asset:retro/lib/src/components/itemCreate/itemCreate.html',ViewEncapsulation.None,styles_ItemCreateComponent);
...
const ComponentFactory ItemCreateComponentNgFactory = const ComponentFactory('item-create',viewFactory_ItemCreateComponentHost0,import6.ItemCreateComponent,_METADATA);
